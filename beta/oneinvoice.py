...
if choice == "Create Invoice":
    ...
    with col1a:
        ...
        with logo1:
            ...
            st.image(logo) #to use full width
...
def generate_pdf(customer, address, invoice_number, invoice_date, due_date, description, quantity, amount, total):
    ...
    column1_x = 10
    column2_x = 110  # Adjust this value based on the width of column 1 and any padding desired

    pdf.set_font("Arial", size=12)
    
    # pdf.image("logo2.png", x=10, y=20, w=50)
