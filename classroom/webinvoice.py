...
csv_filename = "https://raw.githubusercontent.com/mr-temiitayo/pythonstreamlit/main/beta/user_data.csv"
...
if choice == "Create Invoice":
    ...
    with col1a:
        ...
        #------
        #logo = Image.open('https://raw.githubusercontent.co/github.com/mr-temiitayo/pythonstreamlit/blob/main/beta/logo2.png')
